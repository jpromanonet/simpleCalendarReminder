...
<head>
    ...
    <title>Simple Calendar Reminder</title>
                ...
                <div class="modal-content">
                    <form class="form-horizontal" method="POST" action="core/newEvent.php">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="start" class="col-sm-10 control-label">Start date and time</label>
                                <div class="col-sm-10">
                                    <input type="text" name="start" class="form-control" id="start">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="end" class="col-sm-10 control-label">End date and time</label>
                                <div class="col-sm-10">
            ...
            function update(event) {
                ...
                $.ajax({
                    ...
                    success: function(rep) {
                        if (rep == 'ohSi') {
                            $( "#result" ).html('The event was correctly edited.');
                            $('#alert').modal('show');
                        } else {
                            $( "#result" ).html('Cant edit, try again!.');
                            $('#alert').modal('show');
                        }
                    }
                });
